...
class BookListView(generic.ListView):
    model = Book
    paginate_by = 10
    #built in method, show specific number of items on each page
...
# same as @login_required 
# from django.contrib.auth.mixins import LoginRequiredMixin
# class ViewName(LoginRequiredMixin, View):
#     login_url = '/login/'
...
class LoanedBooksByUserListView(LoginRequiredMixin,generic.ListView):
    ...
    model = BookInstance
    template_name = 'catalog/borrowed_user.html'
    paginate_by = 10
...
class AuthorCreate(PermissionRequiredMixin, CreateView):
    ...
    permission_required = 'catalog.add_author'   #naming convention app.action_model
...
class AuthorDelete(PermissionRequiredMixin, DeleteView):
    model = Author
    success_url = reverse_lazy('authors')   #goes back to author list
